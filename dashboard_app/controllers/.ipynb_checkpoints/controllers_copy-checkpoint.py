...
def get_today_acw_att_cph():
    ...
    # シフトデータをjoin
    dataset = dataset.join(df_shift, how='outer').fillna('')
...
def get_today_acw_att_cph_to_html():
    ...
    dashboard_sv = os.path.join(index_path_sv, 'dashboard.html')
    ...
    with open(index_file_sv, 'w') as f1, open(index_file_2g, 'w') as f2, open(index_file_team, 'w') as f3:
        f1.write(html_to_performance)
        f2.write(html_to_performance)
        f3.write(html_to_performance)